...
def runMCB(nReplications=25, sampleSize=50000, filepath=None):
	...
	for year in range(2013, 2020):
		...
		maxScoresMatrix = maxScores[:, yearIndex, :].reshape((6, nReplications))
		...
		espnCountsMatrix = espnCounts[:, yearIndex, :].reshape((6, nReplications))
		...
		lowerBounds, upperBounds = mcb(espnCountsMatrix)
		sys.stdout.write('Interval LB,')
		for modelIndex in range(6):
			sys.stdout.write('{0:.2f},'.format(lowerBounds[modelIndex]))
		sys.stdout.write('\nInterval UB,')
